(function() {
    ...
    return this.toLowerCase().replace(/(^|[^a-z])([a-z])/g, function(m, p1, p2)
    {
        return p1 + p2.toUpperCase();
			...
			ed.addShortcut('meta+alt+l','Lowercase', ['nocaps', false, 'Lowercase'], this);
			ed.addShortcut('meta+alt+u','Uppercase', ['allcaps', false, 'Uppercase'], this);
			ed.addShortcut('meta+alt+s','Sentence Case', ['sentencecase', false, 'Sentence Case'], this);
			ed.addShortcut('meta+alt+t','Title Case', ['titlecase', false, 'Lowercase'], this);
			
			// Register the buttons
            ed.addButton('nocaps', {
                title : 'Lowercase (Ctrl+Alt+L)',
                image : url+'/nc.png',
				cmd : 'nocaps',
            });
            ed.addButton('allcaps', {
                title : 'Uppercase (Ctrl+Alt+U)',
                image : url+'/ac.png',
				cmd : 'allcaps',
            });
            ed.addButton('sentencecase', {
                title : 'Sentence Case (Ctrl+Alt+S)',
                image : url+'/sc.png',
				cmd : 'sentencecase',
            });
			ed.addButton('titlecase', {
                title : 'Title Case (Ctrl+Alt+T)',
                image : url+'/tc.png',
				cmd : 'titlecase',
            });
        },
